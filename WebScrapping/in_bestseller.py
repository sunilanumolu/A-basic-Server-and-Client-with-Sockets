...
for x in range(5):
	p=x+1
	page=requests.get("https://www.amazon.in/gp/bestsellers/books/#"+str(p))
	...
	for container in containers:
					...
					if(container.a["href"]!=None):
					   ref="https://www.amazon.in"+container.a["href"]
					else:
					   ref="Not Available"  
...
with open("output/in_book.csv","w",newline='') as csvfile:
